 ...
 */
package com.zakapps.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ZakappsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ZakappsFulfilmentProcessConstants.PARENT_PROCESS);
