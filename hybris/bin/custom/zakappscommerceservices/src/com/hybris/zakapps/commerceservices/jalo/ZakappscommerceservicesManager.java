...
/**
 * This is the extension manager of the Zakappscommerceservices extension.
 */
public class ZakappscommerceservicesManager extends GeneratedZakappscommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ZakappscommerceservicesManager.class);
	 ...
	 */
	public static ZakappscommerceservicesManager getInstance()
	{
		return (ZakappscommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ZakappscommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ZakappscommerceservicesManager() // NOPMD 
	{
		LOG.debug("constructor of ZakappscommerceservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ZakappscommerceservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ZakappscommerceservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
