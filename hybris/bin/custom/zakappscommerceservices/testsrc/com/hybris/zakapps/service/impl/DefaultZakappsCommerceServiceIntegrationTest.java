package com.hybris.zakapps.service.impl;
 ...
 */
@IntegrationTest
public class DefaultZakappsCommerceServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "zakappscommerceservicesPlatformLogo";

		// when
		final String logoUrl = zakappsCommerceService.getHybrisLogoUrl(logoCode);
