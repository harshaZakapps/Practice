 ...
 */
package com.hybris.zakapps.controller;
...
@Controller
public class ZakappscommerceservicesHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", zakappsCommerceService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
