 ...
 */
package com.hybris.zakapps.cockpits.setup;
...
import com.hybris.zakapps.cockpits.constants.ZakappsCockpitsConstants;
 ...
 */
@SystemSetup(extension = ZakappsCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ZakappsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ZakappsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ZakappsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/zakappscockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
