 ...
 */
package com.hybris.zakapps.test.setup;
...
import com.hybris.zakapps.test.constants.ZakappsTestConstants;
import com.hybris.zakapps.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ZakappsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/zakappstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/zakappstest/import/reviews.impex");
			...
			importImpexFile(context, "/zakappstest/import/cstickets.impex");
		}
	}
}
